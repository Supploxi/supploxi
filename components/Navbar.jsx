...
const dropdowns = {
  Products: [
    { title: 'Supplier Management', desc: 'Track and manage your Chinese suppliers', icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
    )},
    { title: 'Purchase Orders', desc: 'Generate professional POs instantly', icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
    )},
    { title: 'Inventory Management', desc: 'Real-time stock control', icon: (
    ...
    { title: 'Shipment Tracking', desc: 'Automatic tracking for all packages', icon: (
    ...
    { title: 'Tariff Calculator', desc: 'Section 301 duties calculator', icon: (
  ...
  Solutions: [
    { title: 'Shopify Sellers', desc: 'Sync orders and inventory automatically', icon: (
    ...
    { title: 'Amazon Sellers', desc: 'Coming Soon', badge: 'Soon', icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
    )},
    { title: 'Multi-channel Sellers', desc: 'Coming Soon', badge: 'Soon', icon: (
  ...
  Resources: [
    { title: 'Documentation', desc: 'How to use Supploxi', icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
    )},
    { title: 'Blog', desc: 'Tips for China importers', icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
    )},
    { title: 'Changelog', desc: "What's new", icon: (
                  ...
                  <div className={`dropdown${activeDropdown === link ? ' open' : ''}`}>
                    <div className="dropdown-inner">
                      {dropdowns[link].map((item) => (
                        <a key={item.title} href="#" className="dropdown-item">
          ...
          <div key={link}>
            ...
            {dropdowns[link] && (
              <div className="mobile-sub">
                {dropdowns[link].map((item) => (
                  <a key={item.title} href="#" className="mobile-sub-item">
